...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4G3C7B5VV24hh1Hg5JY2"; // AccessKeyId

        $accessKeySecret = "YseqnXwz35ilENvLsgJYS1ulfUYecG"; // AccessKeySecret
    ...
    public static function sendSms($phoneNumber) {
        ...
        $request->setSignName("陌探");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_197871494");
